...
exports.commands = {
	...
	icon: {
		set: function (target, room, user) {
			...
			this.sendReply("|raw|You have given " + OCPU.nameColor(target[0], true) + " an icon.");
			...
			if (Users(target[0]) && Users(target[0]).connected) Users(target[0]).popup("|html|" + OCPU.nameColor(user.name, true) + " has set your userlist icon to: <img src='" + target[1] + "' width='32' height='32'><br><center>Refresh, If you don't see it.</center>");
		...
		delete: function (target, room, user) {
			...
			if (Users(target) && Users(target).connected) Users(target).popup("|html|" + OCPU.nameColor(user.name, true) + " has removed your userlist icon.");
		},
	},
	iconhelp: [
		"Commands Include:",
